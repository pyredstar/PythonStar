...
class ZhihuSpider(Spider):
    ...
    def start_requests(self):
        ...
        yield  Request(self.follow_url.format(user=self.start_user, include=self.follow_query, limit=20, offset=0), self.parse_follows)
    ...
    def parse_user(self, response):
        ...
        yield item
        yield Request(
            self.follow_url.format(user=result.get('url_token'), include=self.follow_query, limit=20, offset=0),
            self.parse_follows)
        yield Request(
